<#--
 kumbuka.ai — password-reset (html).
-->
<!doctype html>
...
<div style="display:none;max-height:0;overflow:hidden;opacity:0;">${msg("passwordResetBodyText")}</div>
...
<tr><td align="center" style="padding:32px 16px;">
  <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;">
    ...
    <tr><td style="background:#F4F1EA;padding:36px 32px 30px;border:1px solid rgba(244,241,234,0.12);border-top:0;">
      <p style="margin:0 0 14px;font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:#FF5B1F;">// reset password</p>
      <h1 style="margin:0 0 14px;font-family:'Space Grotesk',Arial,sans-serif;font-size:26px;font-weight:600;letter-spacing:-0.02em;color:#141820;line-height:1.1;">${msg("passwordResetSubject")}</h1>
      ...
      <table role="presentation" cellpadding="0" cellspacing="0"><tr>
        <td bgcolor="#FF5B1F" style="background:#FF5B1F;">
          <a href="${link}" style="display:inline-block;padding:14px 26px;font-family:'JetBrains Mono',Arial,sans-serif;font-size:12px;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:#1a0d05;text-decoration:none;">${msg("passwordResetCta")} →</a>
        </td>
      </tr></table>
    ...
    <tr><td style="padding:18px 32px 0;">
      <p style="margin:0;font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:0.06em;color:rgba(244,241,234,0.5);">
        ${msg("kumbukaPrivacyFooter")} · If you did not request this, you can safely ignore it.
      </p>
    </td></tr>
