...
public final class MemoryKeyValidator {
     ...
     * Same shape the DB CHECK in V2 enforces. The pattern itself lives in
     * {@link SlugPatterns#KEY} — the single holder of the canonical
     * identifier grammars.
     */
    public static final Pattern PATTERN = SlugPatterns.KEY;
